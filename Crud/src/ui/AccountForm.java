...
public class AccountForm extends JFrame {
    ...
    public AccountForm() {
        ...
        JLabel lblInfo = new JLabel("Salviejo, Victor Louis R. - BSIT 3A");
        lblInfo.setBounds(60, 343, 262, 25);
        getContentPane().add(lblInfo);
        
        AccountVicky vicky = new AccountVicky();
        ...
        btnLoad.addActionListener(e -> {
            try {
                List<Account> list = vicky.getAllAccounts();
                txtOutput.setText("");
                for (Account a : list) {
